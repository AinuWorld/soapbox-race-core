...
public class UserBO {
    ...
    private UserEntity createUser(String email, String password, String ip) {
    ...
    public void createUserWithTicket(String email, PasswordVerifier password, String ip, String ticket) throws AuthException {
        ...
        if (ticketToken != null && !ticketToken.equals("null")) {
            ...
            if (inviteTicketEntity == null || inviteTicketEntity.getTicket() == null ||
                    inviteTicketEntity.getTicket().isEmpty()) {
